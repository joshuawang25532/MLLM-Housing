...
def process_houses(source_dir: str = "data/preprocessed_houses", dest_dir: str = "data/encoded_houses"):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Source directory containing house JSON files (default: data/preprocessed_houses)"
    )
    parser.add_argument(
        "--dest",
        type=str,
        default="data/encoded_houses",
        help="Destination directory for one-hot encoded houses (default: data/encoded_houses)"
    )
