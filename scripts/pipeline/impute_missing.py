...
def process_houses(
    source_dir: str = "data/encoded_houses",
    dest_dir: str = "data/imputed_houses",
    n_neighbors: int = 5,
    weights: str = 'distance'
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--source",
        type=str,
        default="data/encoded_houses",
        help="Source directory containing one-hot encoded house JSON files (default: data/encoded_houses)"
    )
    parser.add_argument(
        "--dest",
        type=str,
        default="data/imputed_houses",
        help="Destination directory for imputed houses (default: data/imputed_houses)"
    )
    parser.add_argument(
        "--k",
        type=int,
