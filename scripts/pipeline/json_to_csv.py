...
Usage:
    python3 scripts/pipeline/json_to_csv.py [--source data/imputed_houses] [--output data/final_dataset.csv]
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Source directory containing house JSON files (default: data/imputed_houses)"
    )
    parser.add_argument(
        "--output",
        type=str,
        default="data/final_dataset.csv",
        help="Output CSV file path (default: data/final_dataset.csv)"
    )
