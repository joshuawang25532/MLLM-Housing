...
from nodriver_validator import HouseValidator
...
def categorize_houses(source_dir="nodriver_houses"):
    """
...
def preprocess_houses(source_dir="nodriver_houses", dest_dir="filtered_houses"):
    """
...
def filter_houses(source_dir="houses_preprocessed", dest_dir="filtered_houses", home_types=None):
    """
...
def main():
    ...
    parser.add_argument(
        ...
        help="Source directory containing house JSON files (default: nodriver_houses)"
    )
    parser.add_argument(
        "--dest",
        type=str,
        default="filtered_houses",
        help="Destination directory for preprocessed houses (default: filtered_houses)"
    )
    parser.add_argument(
        "--filter-only",
        action="store_true",
